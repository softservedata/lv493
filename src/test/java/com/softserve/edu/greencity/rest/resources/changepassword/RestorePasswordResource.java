package com.softserve.edu.greencity.rest.resources.changepassword;
...
public class RestorePasswordResource extends RestQueries<ResponseCodeEntity,
        ResponseCodeEntity, ResponseCodeEntity,
        ResponseCodeEntity,  ResponseCodeEntity> {


    public RestorePasswordResource() {
        super(RestUrlRepository.getRestorePassword());
        initParameters();
    }
