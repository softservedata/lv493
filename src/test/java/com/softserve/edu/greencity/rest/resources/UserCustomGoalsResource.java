...
public class UserCustomGoalsResource extends
		RestQueries<UserGoalEntity, UserGoalEntity,
		ResponseCodeEntity, ResponseCodeEntity, UserGoalEntity> {

    public UserCustomGoalsResource() {
        super(RestUrlRepository.getCustomUserGoals());
        initParameters();
    }
