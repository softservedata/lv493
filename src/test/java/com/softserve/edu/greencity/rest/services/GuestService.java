...
public class GuestService {
    ...
    public RegisterUserEntity unsuccessfulUserRegistration(Languages language, User user) {
        ...
        //
        logger.trace("got REST POST response: name = " + registerUserEntities.get(0).getName() + "; message = " + registerUserEntities.get(0).getMessage());
        logger.info("got REST POST response: name = " + registerUserEntities.get(0).getName() + "; message = " + registerUserEntities.get(0).getMessage());
...
//                       .getResponseCode(registerUserEntities.);
        logger.trace("got REST POST response: name = " + resultGC528Data.getName() + "; message = " + resultGC528Data.getMessage());
        logger.info("got REST POST response: name = " + resultGC528Data.getName() + "; message = " + resultGC528Data.getMessage());
    ...
    public GC532Data userStory184Test532(Languages language, User user) {
        ...
        registerUserEntities = signUpResource
                .httpPostAsListEntity(methodParameters.addMediaTypeParameters(mediaTypeParameters).addHeaderParameters(headerParameters));
        //
//        logger.trace("got REST POST response: name = " + resultGC532Data.getName() + "; message = " + resultGC528Data.getMessage());
        logger.info("got REST POST response: name = " + registerUserEntities.get(0).getName() + "; message = " + registerUserEntities.get(0).getMessage());
        return (GC532Data) GC532Data.converToGC532DataList(registerUserEntities);
    }
 ...
 // (Jira Story: GC-184/GC-468; Test GC-533)
    public GC533Data userStory184Test533(Languages language, User user, WebDriver driver) {
        ...
        //
        logger.debug("start unsuccessfulUserLogin with parameters: user = " + user);
        logger.trace("preparing REST request for unsuccessfully user registration");
        methodParameters = new MethodParameters().addContentType(ContentTypes.APPLICATION_JSON);
        logger.trace("forming REST request for unsuccessfully user logging");
        mediaTypeParameters = new RestParameters().addParameter(KeyParameters.EMAIL, user.getEmail())
                .addParameter(KeyParameters.PASSWORD, user.getPassword());
        headerParameters = new RestParameters().addParameter(KeyParameters.ACCEPT, ContentTypes.ALL_TYPES.toString());
    ...
    public GC534Data userStory184Test534(Languages language, User user) {
        ...
        resultGC534Data.setName(registerUserEntities.get(0).getName())
                       .setMessage(registerUserEntities.get(0).getMessage());
//                       .getResponseCode(registerUserEntities.);
        logger.trace("got REST POST response: name = " + resultGC534Data.getName() + "; message = " + resultGC534Data.getMessage());
        logger.info("got REST POST response: name = " + resultGC534Data.getName() + "; message = " + resultGC534Data.getMessage());
    ...
    public GC535Data userStory184Test535(Languages language, User user) {
        ...
        resultGC535Data.setName(registerUserEntities.get(0).getName())
                       .setMessage(registerUserEntities.get(0).getMessage());
//                       .getResponseCode(registerUserEntities.);
        logger.trace("got REST POST response: name = " + resultGC535Data.getName() + "; message = " + resultGC535Data.getMessage());
        logger.info("got REST POST response: name = " + resultGC535Data.getName() + "; message = " + resultGC535Data.getMessage());
    ...
    public GC536Data userStory184Test536(Languages language, User user) {
        ...
        resultGC536Data.setName(registerUserEntities.get(0).getName())
                       .setMessage(registerUserEntities.get(0).getMessage());
//                       .getResponseCode(registerUserEntities.);
        logger.trace("got REST POST response: name = " + resultGC536Data.getName() + "; message = " + resultGC536Data.getMessage());
        logger.info("got REST POST response: name = " + resultGC536Data.getName() + "; message = " + resultGC536Data.getMessage());
    ...
    public GC537Data userStory184Test537(Languages language, User user) {
        ...
        resultGC537Data.setName(registerUserEntities.get(0).getName())
                       .setMessage(registerUserEntities.get(0).getMessage());
//                       .getResponseCode(registerUserEntities.);
        logger.trace("got REST POST response: name = " + resultGC537Data.getName() + "; message = " + resultGC537Data.getMessage());
        logger.info("got REST POST response: name = " + resultGC537Data.getName() + "; message = " + resultGC537Data.getMessage());
...
//                       .getResponseCode(registerUserEntities.);
        logger.trace("got REST POST response: name = " + resultGC540Data.getName() + "; message = " + resultGC540Data.getMessage());
        logger.info("got REST POST response: name = " + resultGC540Data.getName() + "; message = " + resultGC540Data.getMessage());
    ...
    public GC541Data userStory184Test541(Languages language, User user) {
        ...
        resultGC541Data.setName(registerUserEntities.get(0).getName())
                       .setMessage(registerUserEntities.get(0).getMessage());
//                       .getResponseCode(registerUserEntities.);
        logger.trace("got REST POST response: name = " + resultGC541Data.getName() + "; message = " + resultGC541Data.getMessage());
        logger.info("got REST POST response: name = " + resultGC541Data.getName() + "; message = " + resultGC541Data.getMessage());
