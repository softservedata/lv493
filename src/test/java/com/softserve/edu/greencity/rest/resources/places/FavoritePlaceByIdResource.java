...
public class FavoritePlaceByIdResource extends RestQueries<PlaceEntity, ResponseCodeEntity,
        ResponseCodeEntity, ResponseCodeEntity, ResponseCodeEntity> {


        public FavoritePlaceByIdResource() {
            super(RestUrlRepository.favoritePlacesById());
            initParameters();
        }
