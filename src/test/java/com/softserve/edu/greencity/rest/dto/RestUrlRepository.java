...
public final class RestUrlRepository {
    ...
    private static String remoteServer = "https://greencity.azurewebsites.net";
            //"https://greencity.azurewebsites.net";
...
//                .addBaseUrl(localServer)
    ...
    public static RestUrl favoritePlaces() {
        return new RestUrl()
                ...
                .addDeleteUrl("/favorite_place/{" + KeyParameters.PLACE_ID2.toString() + "}")
                .addPatchUrl("");
    }
    ...
    public static RestUrl favoritePlacesById() {
        return new RestUrl()
                .addBaseUrl(remoteServer)
                .addGetUrl("/favorite_place/favorite/{" + KeyParameters.PLACE_ID2.toString() + "}")
                .addPostUrl("")
                .addPutUrl("")
                .addDeleteUrl("")
                .addPatchUrl("");
