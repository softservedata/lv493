...
public class UserHabitStatisticResource extends
		RestQueries<UserHabitStatisticEntity, ResponseCodeEntity, ResponseCodeEntity, ResponseCodeEntity, ResponseCodeEntity> {

	public UserHabitStatisticResource() {
		super(RestUrlRepository.getUserHabitsStatistic());
		initParameters();
	}

	private void initParameters() {
		addEntityParameters(RestHttpMethods.GET, UserHabitStatisticEntity.class);
		...
		addListEntityParameters(RestHttpMethods.GET,
				new GenericConverter<List<UserHabitStatisticEntity>>(){}.getGenericType());
