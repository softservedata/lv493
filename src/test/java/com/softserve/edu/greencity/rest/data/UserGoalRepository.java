...
public class UserGoalRepository {
	...
	public UserGoal myGoal() {
        return new UserGoal("myGoal", "");
    }

	public UserGoal myNewGoal() {
        return new UserGoal("myNewGoal", "");
    }

	public List<UserGoal> addGoalList() {
        List<UserGoal> result = new ArrayList<>();
        result.add(myGoal());
        result.add(myNewGoal());
