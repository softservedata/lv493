...
public final class UserRepository {
    ...
    public User googleUserCredentials() {
        return new User("sergii.taqc@gmail.com",
                "A475asd123*");
    }

    /**
     * GoogleUserCredentials:
     * email "xoboj58975@2go-mail.com";
     * password "Qwerty42?".
     * @return UserData
     */
    public User validLoginUserCredentials() {
        return new User("xoboj58975@2go-mail.com",
                "Qwerty42?");
    }

    /**
     * GoogleUserCredentials:
     * email "xoboj575@2go-mail.com";
     * password "111111111".
     * @return UserData
     */
    public User wrongLoginUserCredentials() {
        return new User("xoboj575@2go-mail.com",
                "111111111");
    }
    ...
    public User temporaryUserCredentialsForRegistration() {
        return new User(Randomizer.getRamdomString20Letters(),
                Randomizer.getRamdomString20Letters(),
                "",
                "A475asd123*");
    }
