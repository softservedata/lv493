...
//				"./lib/geckodriver.exe");
		...
		FirefoxProfile profile = new FirefoxProfile(new File(
				...
				//System.getenv("HOMEPATH") + "\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\xv0c0oyh.default-1539880051618"));
				System.getenv("USERPROFILE") + "\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\ag2q6v21.default-release"));
		//
...
//				"./lib/geckodriver.exe");
	...
	public void testFirefox4() throws Exception {
		...
		File file = new File("./lib/selenium_ide-3.17.0-fx.xpi");
...
//		WebDriverManager.edgedriver().setup();
		//
//		System.setProperty("webdriver.edge.driverr",
//				"C:\\Program Files\\Internet Explorer\\IEDriverServer64.exe");
...
//				"./lib/phantomjs.exe");
	...
	@Test
	public void testAcademy() throws Exception {
		/*-
		// 1. Chrome
		WebDriverManager.chromedriver().setup();
		//
		...
		*/
		...
		System.out.println("\tdriver.get https://softserve.academy/ DONE");
		System.out.println("\tCurrent title is: " + driver.getTitle());
		//
		WebElement elementLogin = driver.findElement(By.linkText("Log in"));
		System.out.println("\telement Login found");
		elementLogin.click();
		Thread.sleep(1000);
		System.out.println("\telementLogin.click(); DONE");
		Thread.sleep(1000);
		driver.quit();
	}
}
