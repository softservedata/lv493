...
//                //this.getClass().getResource("/chromedriver-windows-32bit.exe").getPath().substring(1));
        ...
        //
        List<WebElement> advertButtons = driver.findElements(By.cssSelector("button.cookie-module--button--Kube8"));
        if (advertButtons.size() > 0) {
        	advertButtons.get(0).click();
        }
        //
...
//                driver.findElement(By.xpath("//div[@id='grid-paging-remote-paging-demo-pane-preview']//iframe")));
        driver.switchTo().frame(
                driver.findElement(By.xpath("//h2[@id='use-paging-with-other-data-processing-plugins']/preceding-sibling::div[1]//iframe")));
        // Switch To IFrame
