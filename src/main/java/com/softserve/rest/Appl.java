...
//		String postal = "http://ua-postalcodes.rhcloud.com/api/regions";
		...
		// String heroku =
		// "https://schedule-lv215.herokuapp.com/meetings/restByRoom?start=2017-02-14&end=2017-02-14&roomId=100";
		// String localHost = "http://localhost:8080/";
		// String localHost =
		// "http://localhost:8080/admins?token=FXVYJMPKS3RJ170RHJMUD0VSS8D3D044";
		String localHost = "http://localhost:8080/user?token=FXVYJMPKS3RJ170RHJMUD0VSS8D3D044&name=petro";
		// String localHost =
		// "http://localhost:8080/tokenlifetime?token=FXVYJMPKS3RJ170RHJMUD0VSS8D3D044&time=1000000";
